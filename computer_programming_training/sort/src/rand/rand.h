// rand.h		产生服从高斯分布（正态分布）和均匀分布的随机数
#ifndef MY_RAND_H
#define MY_RAND_H
/*
...
double gauss_rand(double mean=0, double variance=1);	// 正态分布(高斯分布) mena:均值、数学期望，variance方差
double uniform_rand(double a=0, double b=1);			// 区间[a, b]上的均匀分布
