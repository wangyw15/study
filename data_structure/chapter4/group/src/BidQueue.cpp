...
int main()
{
    ...
    queue.Clear();
    cout << "cleared: " << queue << "; length: " << queue.Length() << "; is "
         << (queue.IsEmpty() ? "" : "not") << "empty" << endl
         << endl;
    ...
    cout << "length: " << queue.Length() << "; head: " << queue.Head() << endl
         << endl;
    cout << "dequeue: " << endl;
    for (auto i = 100; i < 150; i++)
    {
